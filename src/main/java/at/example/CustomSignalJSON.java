...
public class CustomSignalJSON {
    ...
    public void recalculateFinalAlert() {
        ...
        switch(this.difficulty) {
            ...
            case ADVANCED -> {
                if(weatherConditions.get("R") != 2 && weatherConditions.get("R") == 3) alert = FinalAlertCategory.E4;
                if(alert == FinalAlertCategory.E4 && weatherConditions.get("F") != 2 && weatherConditions.get("F") == 3) alert = FinalAlertCategory.E3;
                if(alert == FinalAlertCategory.E3 && weatherConditions.get("R") != 3) alert = FinalAlertCategory.E2;
                boolean condition =
                        weatherConditions.get("W") < 2 &&
                        weatherConditions.get("F") < 3 &&
                        weatherConditions.get("T") < 3 &&
                        weatherConditions.get("A") < 3;
                if(alert == FinalAlertCategory.E2 && condition) alert = FinalAlertCategory.E1;
            }
        }
        this.category = alert;
    }
